...
<head>
    ...
    <style>
        ...
        .dashboard h1 { color: #ffcc00; }
        .dashboard h2 { color: #000000; border-bottom: 2px solid #ffcc00; padding-bottom: 10px; margin-top: 30px;}
        ...
        .dashboard__item h3 { font-size: 2.5em; margin-bottom: 10px; color: #007bff; }
        .dashboard__item h4 { margin-top: 0; font-size: 1.1em; color: #333333; }
        .dashboard__item small { color: #666666; }
        ...
        .cta-strip span { font-weight: bold; color: #333333; }
